...
export const Header = () => (
  <header className="w-full px-4 text-white mb-12">
    <div className="flex items-center justify-between gap-8">
      {/* LOGO LEFT */}
      <Link to="/" className="flex items-center gap-3 shrink-0">
        <img src={logo} alt="PowerWin" className="w-[120px] h-auto" />
        <span className="hidden sm:inline text-[36px] text-black font-semibold">POWER&nbsp;WIN</span>
      </Link>
      ...
      <div className="flex items-center gap-6 shrink-0">
        {/* WALLET */}
        <div className="rounded-[16px] border border-white/20 bg-card px-4 py-3 text-sm text-left bg-[linear-gradient(90deg,var(--pw-button-primary-color),var(--pw-button-secondary-color))]">
        ...
        {/* PROFILE */}
        <div className="rounded-[16px] flex flex-col items-center border border-white/20 bg-card px-4 py-3 text-center text-sm bg-[linear-gradient(90deg,var(--pw-button-primary-color),var(--pw-button-secondary-color))]">
          <User s={16} />
        ...
        <div className="flex flex-col items-center gap-1">
          <button className="rounded-[8px] border border-white/20 bg-card px-4 py-3 text-sm  bg-[linear-gradient(90deg,var(--pw-button-primary-color),var(--pw-button-secondary-color))]">
            EN
          </button>
          <button className="rounded-[8px] border border-white/20 bg-card px-4 py-3 text-sm bg-[linear-gradient(90deg,var(--pw-button-primary-color),var(--pw-button-secondary-color))]">
